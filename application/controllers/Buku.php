...
class Buku extends CI_Controller {
    ...
    public function kategori() {
        ...
        // Mengambil detail laporan dan tiket berdasarkan pengguna
        $data[ 'detail_laporan' ] = $this->ModelUser->getLaporanAkhir();
        $data[ 'detail_laporan_user' ] = $this->ModelUser->getTiketByUser( $data[ 'user' ][ 'email' ] );
        // Menggunakan email pengguna
        ...
        if ( $this->form_validation->run() == false ) {
            ...
            $this->ModelBuku->simpanKategori( $kategori_data );
